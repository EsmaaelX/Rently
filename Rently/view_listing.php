        ...
        <div class="listing-main">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                <p style="color: #718096; margin: 0; font-size: 1.1rem;">
                    ...
                    <a href="user.php?id=<?= $listing['user_id'] ?>" style="color:inherit; text-decoration:none; display:inline-flex; align-items:center; gap:8px;">
                        <img src="<?= htmlspecialchars($listing['owner_pic'] ?? 'assets/img/default_avatar.png') ?>" style="width:28px; height:28px; border-radius:50%; object-fit:cover; border:2px solid var(--primary-color);">
