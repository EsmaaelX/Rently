...
try {
    ...
    $stmtListing->execute([10, 5, '2023 Toyota Corolla', 'Very reliable car for family trips.', 'Cars', 50.00, 'day', 'Haifa', 'https://images.pexels.com/photos/170811/pexels-photo-170811.jpeg?auto=compress&cs=tinysrgb&w=600', json_encode(['make'=>'Toyota', 'year'=>'2023', 'seats'=>5]), 'approved']);
    $stmtListing->execute([11, 6, 'Traditional Villa', 'Spacious villa with authentic design.', 'Apartments', 250.00, 'day', 'Nazareth', 'https://images.pexels.com/photos/208736/pexels-photo-208736.jpeg?auto=compress&cs=tinysrgb&w=600', json_encode(['rooms'=>4, 'bathrooms'=>3]), 'approved']);
    $stmtListing->execute([12, 7, 'DJ Pioneer Setup', 'Full professional DJ setup.', 'Equipment', 30.00, 'hour', 'Ramallah', 'https://images.pexels.com/photos/164745/pexels-photo-164745.jpeg?auto=compress&cs=tinysrgb&w=600', null, 'approved']);
    $stmtListing->execute([13, 8, 'Sea View Studio', 'Beautiful studio right next to the sea.', 'Apartments', 150.00, 'day', 'Jaffa', 'https://images.pexels.com/photos/2082087/pexels-photo-2082087.jpeg?auto=compress&cs=tinysrgb&w=600', json_encode(['rooms'=>1, 'bathrooms'=>1]), 'approved']);
    $stmtListing->execute([14, 9, '2021 Hyundai Tucson', 'Great SUV for the whole family.', 'Cars', 75.00, 'day', 'Tel Aviv', 'https://images.pexels.com/photos/112460/pexels-photo-112460.jpeg?auto=compress&cs=tinysrgb&w=600', json_encode(['make'=>'Hyundai', 'year'=>'2021', 'seats'=>5]), 'approved']);
    $stmtListing->execute([15, 10, 'Luxury Penthouse', 'High-end penthouse with a pool.', 'Apartments', 600.00, 'day', 'Herzliya', 'https://images.pexels.com/photos/3150591/pexels-photo-3150591.jpeg?auto=compress&cs=tinysrgb&w=600', json_encode(['rooms'=>5, 'bathrooms'=>4]), 'approved']);
    ...
    $stmtListing->execute([17, 12, 'Mountain Bike', 'Professional mountain bike.', 'Equipment', 25.00, 'day', 'Eilat', 'https://images.pexels.com/photos/100582/pexels-photo-100582.jpeg?auto=compress&cs=tinysrgb&w=600', null, 'approved']);
    $stmtListing->execute([18, 5, 'Vintage Rolex Watch', 'Beautiful vintage watch for special events.', 'Equipment', 100.00, 'day', 'Haifa', 'https://images.pexels.com/photos/277390/pexels-photo-277390.jpeg?auto=compress&cs=tinysrgb&w=600', null, 'approved']);
