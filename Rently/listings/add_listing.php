            ...
            if (isset($mainUpload['error'])) {
                ...
                if (empty($error)) {
                    try {
                        ...
                        $pdo->commit();
                        notifyAdmins($pdo, "New Listing Requires Approval", "A new listing '<strong>" . htmlspecialchars($title) . "</strong>' has been submitted and is pending approval.<br><br>Please check the admin dashboard.");
        ...
        <form method="POST" action="" enctype="multipart/form-data" id="addListingForm">
            ...
            <div class="form-group">
                ...
                <select name="category" id="listingCategory" class="form-control" required>
                    ...
                    <option value="Sports field"><?= __('Sports field') ?></option>
                </select>
            </div>
