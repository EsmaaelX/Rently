        ...
        <form method="POST" action="" enctype="multipart/form-data" id="editListingForm">
            ...
            <div class="form-group">
                ...
                <select name="category" id="listingCategory" class="form-control" required>
                    <option value="Cars" <?= $listing['category'] === 'Cars' ? 'selected' : '' ?>>Cars</option>
                    <option value="Apartments" <?= $listing['category'] === 'Apartments' ? 'selected' : '' ?>>Apartments</option>
                    <option value="Equipment" <?= $listing['category'] === 'Equipment' ? 'selected' : '' ?>>Equipment</option>
                    <option value="Electronics" <?= $listing['category'] === 'Electronics' ? 'selected' : '' ?>>Electronics</option>
                    <option value="Sports field" <?= $listing['category'] === 'Sports field' ? 'selected' : '' ?>>Sports field</option>
                </select>
            </div>
