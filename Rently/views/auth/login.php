            ...
            <div class="col-md-5">
                <div class="glass-card p-5 shadow-lg">
                    <div class="text-center mb-4">
                        ...
                        <h2 class="fw-bold mt-2"><?= t('welcome_back') ?></h2>
                        <p class="text-muted"><?= t('sign_in_account') ?></p>
                    </div>

                    <form method="POST" action="<?= baseUrl() ?>index.php?page=login" id="login-form">
                        <div class="mb-3">
                            <label for="email" class="form-label fw-semibold"><?= t('email_address') ?></label>
                    ...
                    <p class="text-center text-muted mb-0">
                        <?= t('no_account') ?>
                        <a href="<?= baseUrl() ?>index.php?page=register" class="text-accent fw-semibold"><?= t('sign_up') ?></a>
                    </p>
                </div>
            </div>
        </div>
