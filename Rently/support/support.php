...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['subject'], $_POST['message'])) {
    if (!isset($_POST['csrf_token']) || !verifyCsrfToken($_POST['csrf_token'])) {
        ...
        if ($subject && $message_text) {
            ...
            notifyAdmins($pdo, "New Support Ticket #{$ticket_id}", "A new support ticket has been opened.<br><br><strong>Subject:</strong> " . htmlspecialchars($subject) . "<br><br>Please check the admin dashboard to reply.");
